/*
	FPS_GT511Linux.h v1.0 - Library for controlling the GT-511Cxx Finger Print Scanner (FPS)
...
#ifndef FPS_GT511Linux_h
#define FPS_GT511Linux_h
...
/*
	Object for controlling the GT-511Cxx Finger Print Scanner (FPS)
*/
class FPS_GT511
{
